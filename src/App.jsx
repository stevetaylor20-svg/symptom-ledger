                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      style={{ borderColor: PALETTE.moss, color: PALETTE.moss, textDecoration: "none" }}
                      title="Opens My Protocol on lymetool.online to save this — you'll need to be logged in there"
                    >
                      <Plus size={10} /> Add to Protocol
                    </a>
                    <span
